...
re = /\w/;    //Word characetr - alphanumeric or _
re = /\w+/;    //+ symbol looks for one or more word character
re = /\W/;    //Non-Word characetr -
re = /\d/;    //This will match any digit
re = /\d+/;    //Match any digit, 1 or more times
re = /\D/;   //Match any non-digit character
re = /\s/;  //Match whitespace character
re = /\S/;  //Match non-whitespace character
re = /\sHell\b/i;  //Word boundary
